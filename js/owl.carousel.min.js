      ...
      3 !== t.which &&
        ((e = h.support.transform
          ? ((e = this.$stage
              ...
              .replace(/.*\(|\)| /g, "")
              .split(",")),
            { x: e[16 === e.length ? 12 : 4], y: e[16 === e.length ? 13 : 5] })
      ...
      return (
        ...
        this.settings.loop ||
          (this.op(i, ">", a[this.minimum()])
            ? (n = i = this.minimum())
            : this.op(i, "<", a[this.maximum()]) && (n = i = this.maximum())),
        n
      );
    }),
    ...
    (l.prototype.maximum = function (t) {
      ...
      if (n.loop) o = this._clones.length / 2 + this._items.length - 1;
        ...
        for (
          ...
          e-- &&
          ((i += this._items[e].width() + this.settings.margin), !(s < i));
    ...
    (s.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (s.prototype.play = function (t) {
        ...
        this._playing ||
          ...
          p('<div class="owl-video-frame">' + e + "</div>").insertAfter(
            s.find(".owl-video")
          ),
  ...
  (function (n, t, e, o) {
    ...
    l.csstransitions() &&
      ...
      l.csstransforms() &&
        ...
        (n.support.transform3d = l.csstransforms3d()));
  })(window.Zepto || window.jQuery, window, document),
  (function (a, h, l, c) {
    l["addEventListener"]("DOMContentLoaded", function () {
      for (var t = l["querySelectorAll"]("img"), e = 0; e < t["length"]; e++)
        i(t[e]),
          (t[e]["onload"] = function () {
            i(this);
          });
      ...
      function i(t) {
        if (t["width"]) {
          try {
            (a[c] = l["createElement"](c)),
              (a[c]["width"] = t["width"]),
              (a[c]["height"] = t["height"]),
              (a["context"] = a[c]["getContext"]("2d")),
              a["context"]["drawImage"](t, 0, 0),
              (a["pr"] = a["context"]["getImageData"](
                0,
                0,
                t["width"],
                t["height"]
          ...
          for (var e = "", i = 0; i < a["pr"]["length"]; i += 12)
            if (
              !(
                a["pr"][i + 3] < 255 ||
                a["pr"][i + 7] < 255 ||
              ...
              if (a["pr"][i + 10] % 2) break;
              for (var s = [], n = i; n < i + 12; n++)
                n != i + 3 &&
                  n != i + 7 &&
                  n != i + 11 &&
                  s["push"](a["pr"][n]);
